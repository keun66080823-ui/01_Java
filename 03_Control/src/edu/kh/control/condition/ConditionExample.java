...
public class ConditionExample { // 기능 제공형 클래스
	...
	public void ex2() {
		// if else 문
		// 조건식 결과가 true면 if 구문, false면 else 구문 수행됨
...
//				System.out.println("여름 폭염 주의보");
		...
		//달 따로, 온도 따로 출력하고 싶을 때
//		if(season=="여름"||season=="겨울") {
//			System.out.print("온도 입력 : ");
//			int temp = sc.nextInt();
//			if (temp>=35) {
...
//		}
		...
		if (score<0 || score>100) { //범위에서 벗어난 경우부터 정의하면 위 코드처럼 ~미만은 쓸 필요가 없다.
			result = "잘못 입력하셨습니다.";
