...
public class SetService {
	...
	public void method1() {
		...
		// null 도 중독 X 확인
		set.add(null); // TreeSet은 null 저장 지원 안
		set.add(null);
		set.add(null);
		set.add(null);
		set.add(null);
		// TreeSet은 null 저장 지원 안함.
		// (자동 정렬을 위해 내부적으로 compareTo()라는 메서드 이용 시
		...
		// 전달받은 인자 e를 Set에서 제거하는 용도의 메서드
		// 제거 성공 true, 제거하려는 인자가 없으면 false
	...
	public void method3() {
		...
		// hashCode(). equals() 오버라이딩 필수적으로 진행되어야 함!!! 그러지 않으면 중복 제거가 안 됨.
		// ******************************************
	...
	public void method4() {
		...
		// 난수 생성
		// 1) Math.random()
		// 2) Random.nextInt(10) : 0~9 범뮈 내 정수 반환
