...
// MVC(model, view(화면), controller(서버통신)) 패턴.
...
public class People { // 국민(사람) 클래스
	...
	// -> 직접 접근 못하기 때문에
	//    클래스 내부에 간접 접근 방법을 제공하는 기능(메서드)을 작성하여 사용한다.
	// -> getter/setter (캡슐화 원칙을 위해 만들어진 메서드)
