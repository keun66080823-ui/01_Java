...
public class User {
	...
	// 기본생성자 자동완성 단축키 : strl + space -> enter
	...
	public User(String userId, String userPw) {
		...
		// 사용 이유  
		// -> 필드명과 매개변수명이 같은 경우 이를 구분하기 위해서 사용.
	}
	...
	public User(String userId, String userPw, String userName, int userAge, char userGender) {
		...
		this(userId, userPw); //이렇게 쓰나 이 밑의 두 줄로 쓰나 똑같다.
//		this.userId = userId;
//		this.userPw = userPw;
...
//	public User(int age, String name) {}
	 ...
	 * 2) 매개변수 생성자
	 * 
	 * *** 생성자가 하나도 없을 때 컴파일러가 기본 생성자를 생성해 줌. ***
	 * 
	 */
