...
public class MemberService {
	...
	// 가입한 회원의 정보를 저장할 변수
	private Member memberInfo = null; //Member가 참조형이므로 null로 초기화해야 한다.
	...
	public String login() {
		...
		if( memberId.equals(memberInfo.getMemberId()) && memberPw.equals(memberInfo.getMemberPw()) ) { // 객체에 저장된 변수를 갖고 오기 위해 getter 사용
