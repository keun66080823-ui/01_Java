...
public class JavaTest {
	...
	// main 작성 후 ctrl+space -> Enter 메인 메서드 자동완성
	public static void main(String[] args) {
		...
		//syso 작성 후 ctrl+space -> Enter System.out.println(); 자동완성
		
		//저장 단축키 ctrl+s
		System.out.println("hi");
		System.out.println(); // 비어있는 경우 개행 역할만 함. 
		...
		// 숫자 연산
		System.out.println("1 + 2"); //쌍따옴표 안에 작성된 코드는 단순 문자열로 인식.
		System.out.println(1+2); //쌍따옴표 안에 작성되지 않은 코드는 숫자, 변수로 인식.
		
		System.out.println(50 - 23);
		System.out.println(12 * 13);
		System.out.println(300 / 5);
		System.out.println(12%2); // 연산자로서 "%"는 퍼센트가 아닌 모듈러(modulo:나머지) 라고 불린다.
