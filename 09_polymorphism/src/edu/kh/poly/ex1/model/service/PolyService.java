...
// 자식타입 참조변수 = new 자식객체주소();		
		...
		// 부모타입 참조변수 = 자식객체주소
		Car car2 = new Tesla(); // 상속 관계이면서 다형성이 적용되어 에러가 안 남.
		...
		car2.setFuel("전기");
		car2.setWheel(4);
		//car.setBatteryCapacity(1000000);
	...
	// 전달받은 Car 또는 자식 객체(Tesla, Spark)의 
	// 엔진, 연료, 바퀴 갯수를 출력하는 메서드
	...
	public void ex3() {
		...
		// 그래서 형변환 부분을 ()로 한 번 묶어주고 나서 . 연산을 진행해야
